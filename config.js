...
global.gurl = 'umar-md.db' // add your username
global.sudo = process.env.SUDO || '923124533358'
global.devs = '233200857544';
global.website = 'https://github.com/arkhan998/MALIK-MD' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/31ae33bf9bf715a84c359.jpg'
module.exports = {
...
│ 👨🏻‍💻 Owner:- *UMAR*
│ 🤙🏻 *CONTACT:-* *+923121870553*
│ 📱 *Device:-* *ANDROID* 
└───────────────

*Hey Bot is Online Now👨🏻‍💻* 
...
└───────────────' : process.env.ALIVE_MESSAGE,
  ...
  VERSION: process.env.VERSION === undefined ? 'v1.0' : process.env.VERSION,
